  ...
  return (
    <nav className="flex justify-between border-b-[0.5px]  border-green-500 bg-black  items-center  p-5 h-24 ">
      <div className="flex gap-5 ">
        <span onClick={()=>navigate("/")} className="text-green-500 text-lg font-semibold cursor-pointer">
          Home
        </span>
        <span onClick={()=>navigate("/recipes")} className="text-green-500 text-lg font-semibold cursor-pointer">
          Recipes
        </span>
      ...
      <div className="px-6 flex gap-2">
       ...
       <button onClick={()=>navigate("/login")} className="btn bg-black text-green-500 border-[0.5px] border-green-500 hover:bg-black hover:text-red-500 hover:border-red-500">
Login
       </button>
       }
      </div>
